    ...
    <div className="min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-50 to-white">
      <div className="max-w-7xl mx-auto">
        ...
        >
          {quickActions.map((action, idx) => (
            ...
            >
              <Link
                to={action.href}
                className={`relative overflow-hidden rounded-xl p-6 text-white shadow-lg hover:shadow-xl transition-all bg-gradient-to-br ${action.color}`}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="bg-white rounded-2xl border border-gray-200/30 shadow-lg p-8">
              ...
              <div className="space-y-4">
                {upcomingAppointments.map((appointment, idx) => (
                  <motion.div
                    ...
                    className="border border-gray-200/30 rounded-xl p-6 hover:bg-gray-50/50 transition-colors group"
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <motion.div
                        ...
                        className="bg-gradient-to-br from-blue-600 to-cyan-500 text-white px-4 py-2 rounded-lg text-sm font-medium"
                      >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full mt-6 py-3 border-2 border-dashed border-gray-300 rounded-xl text-gray-700 font-semibold hover:border-blue-600 hover:text-blue-600 transition-colors flex items-center justify-center gap-2"
              >
