...
public class PatientProfile {
    ...
    /**
     * References the user.id from auth_service_db.users.
     * This is a LOGICAL foreign key (no physical DB constraint across services).
     * The JWT carries this value as the "userId" claim.
     */
